...
<body>
    ...
    <form action="{{Route('enrollmentPost')}}" method="POST" id="enrollmentForm">
        @csrf
        @method('post')
        <!-- First Part -->
        ...
        <div class="form-set" id="enrollmentInfo" style="display: none;">
            ...
            <input type="text" id="special_needs_description" name="special_needs_description" required><br>         
        ...
        <div class="form-set" id="learningInfo" style="display: none;">
            ...
            <input type="checkbox" id="cellphone_tablet" name="learning_info[]" value="0">
            <label for="cellphone_tablet">May sariling Cellphone/Tablet ang Bata</label><br>

            <input type="checkbox" id="computer" name="learning_info[]" value="1">
            <label for="computer">May computer sa bahay</label><br>

            <input type="checkbox" id="no_gadget" name="learning_info[]" value="2">
            <label for="no_gadget">Walang sariling gadget ang bata</label><br>

            <input type="checkbox" id="tv" name="learning_info[]" value="3">
            <label for="tv">May tv sa bahay</label><br>

            <input type="checkbox" id="internet" name="learning_info[]" value="4">
            <label for="internet">May internet connection sa bahay</label><br>

            <input type="checkbox" id="mobile_data" name="learning_info[]" value="5">
    ...
    <script src="{{asset('assets/js/ph-address-selector.js')}}"></script>
</body>
</html>
